...
imu_path = "../Datasets/imu_matlab/imu_ctin_circle.csv"
gt_path = "../Datasets/gt_matlab/gt_vel_ctin_circle.csv"
...
torch.save(model.state_dict(), "ctin_synthetic_loop_noisy_GRU_circle.pth")
